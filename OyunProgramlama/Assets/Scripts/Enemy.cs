...
public class Enemy : MonoBehaviour
{
    ...
    void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            gameObject.transform.rotation = Quaternion.Euler(0, 180, 0);  //objenin rotation değerini 0 larız.
        }

        else  //değilsee
        {
            gameObject.transform.rotation = Quaternion.Euler(0, 0, 0);   //objenin rotation değerinden y yi 180 yaparız diğer tarafa dönmesi için larız.
        }
    }
}
